...
Continous Integration and Continous Deployment (CI/CD) systems are designed to take code from 'git push' to Build, Test, Deploy in production. There is a moving from having a single big build server to cloud native scaleable platforms. 
